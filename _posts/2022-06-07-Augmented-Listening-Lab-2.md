...
AVL\_READ, AVL\_WRITE, AVL\_CS, AVL\_ADDR, AVL\_WRITEDATA, 

AM\_WRITEREQUEST,

AUD\_BCLK, AUD\_ADCLRCK,

GPIO\_DIN1, GPIO\_DIN2, …, GPIO\_DIN8,

[31:0] adc\_data,

1. Output: 

[31:0] AM\_ADDR, [2:0] AM\_BURSTOUNT, AM\_WRITE, 

[31:0] AM\_WRITEDATA, [3:0] AM\_BYTEENABLE,

AVL\_READDATA,

[15 + 16\*(CHANNELS-1): 0] mics,

[(CHANNELS/2)-1:0] wsp, valid\_o,
...
`          `Main .sv file that most sub-system is built on.

1. Module: downsample 
   1. Input: rst, LRCLK, i\_clk, 

`          `[DATA\_WIDTH-1:0] sample\_in, i\_ce

1. Output: [DATA\_WIDTH-1:0] sample\_out,
